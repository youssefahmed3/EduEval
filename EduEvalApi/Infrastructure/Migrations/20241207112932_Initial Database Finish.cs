...
{
    /// <inheritdoc />
    public partial class InitialDatabaseFinish : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionsLibrary", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuestionsLibrary_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TakenAt = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Choices_QuestionsLibrary_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "QuestionsLibrary",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ExamQuestions_QuestionsLibrary_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "QuestionsLibrary",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionsLibrary_SubjectId",
                table: "QuestionsLibrary",
                column: "SubjectId");
